...
IMPORT_TO_PACKAGE_MAPPING = {"wikipediaapi": "wikipedia-api",}
def get_package_name(import_name: str) -> str:
    """
    Return the package name for a given import name.
    Args: import_name (`str`): Import name to get the package name for.
    Returns: `str`: Package name for the given import name.
    """
...
def get_imports(code: str) -> list[str]:
    ...
    Args: code (`str`): Code text to inspect.
    Returns: `list[str]`: List of all packages required to use the input code.
    """
...
def _parse_google_format_docstring(docstring: str,) -> tuple[str | None, dict | None, str | None]:
    """
    Parses a Google-style docstring to extract the function description,
    argument descriptions, and return description.
    Args: docstring (str): The docstring to parse.
    Returns: The function description, arguments, and return description.
    """
